...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    advanced: "Toutes les autres sections de configuration, ainsi que l'éditeur de fichier brut.",
  ...
  mcpPage: {
    connectorsLink: "Découvrez des connecteurs en un clic sur la page Plugins.",
    servers: "Serveurs",
    oauth: "OAuth",
    filtered: "Filtré",
  ...
  appsPage: {
    ...
    heroTagline:
      "Applications compagnons pour votre téléphone, votre montre, votre bureau et votre navigateur — plus des plugins pour étendre les capacités de votre agent.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Votre téléphone Android en tant que nœud OpenClaw complet — chat, caméra et Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Conversations d'un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  chat: {
    ...
    messages: {
      ...
      rewind: "Rembobiner",
      rewindConfirm: "Rembobiner avant ce message ?",
