...
export const ja_JP: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm:
      "{count} 件のアーカイブされたセッションとそのトランスクリプトを削除しますか？",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "macOSでOpenClawの通知が無効になっています。「システム設定」>「通知」で許可してください。",
    },
    appearance: {
      theme: "テーマ",
  ...
  mcpServers: {
    ...
    configUnavailable: "構成が利用できません。更新して再試行してください。",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリ、そしてエージェントの機能を拡張するプラグイン。",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android スマホを完全な OpenClaw ノードとして — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android コンパニオンが OpenClaw を時計にも拡張します。",
      },
      macos: {
        title: "macOS",
      ...
      linux: {
        title: "Linux",
        desc: "ネイティブなデスクトップアプリ — .deb と AppImage ビルド。",
      },
      chrome: {
        title: "Chrome 拡張機能",
        desc: "OpenClaw に既存の Chrome を操作させる — タブ、ページ、フォーム。",
      },
      plugins: {
        title: "プラグイン & ClawHub",
        desc: "コミュニティのチャンネル、ツール、スキルで OpenClaw を拡張。",
      },
    },
  },
  profilePage: {
