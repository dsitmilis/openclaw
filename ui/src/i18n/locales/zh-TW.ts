...
export const zh_TW: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "雲端 worker 需要 OpenClaw 執行環境；目前選擇的是 {runtime}。",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "要刪除 {count} 個封存的工作階段及其記錄嗎？",
  ...
  mcpServers: {
    ...
    nameLabel: "名稱",
    targetLabel: "URL 或指令",
    nameInvalid: "伺服器名稱只能使用字母、數字、點、連字號或底線。",
    ...
    adminRequired: "變更 MCP server 需要 operator.admin 存取權限。",
    enable: "啟用",
    disable: "停用",
    removeNamed: "移除 {name}",
    working: "處理中…",
  ...
  appsPage: {
    ...
    heroTagline: "適用於手機、手錶、桌面與瀏覽器的隨附應用程式，以及擴充代理功能的外掛程式。",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "在 iOS 上聊天、通話、核准動作並分享至 OpenClaw。",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android 隨附程式將 OpenClaw 延伸至你的手錶。",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows 隨附程式將你的 PC 連接為 OpenClaw 節點。",
      },
      linux: {
        title: "Linux",
