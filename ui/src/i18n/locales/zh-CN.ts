...
export const zh_CN: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint: "macOS 已禁用 OpenClaw 的通知。请在“系统设置 > 通知”中允许通知。",
    },
    appearance: {
      theme: "主题",
  ...
  appsPage: {
    ...
    sectionCommunity: "社区",
    badgeBundledIos: "iOS 应用附带",
    badgeBundledAndroid: "Android 应用附带",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "下载",
    ctaDocs: "文档",
    ctaSetupGuide: "设置指南",
    ctaOpenPlugins: "打开 Plugins",
    ...
    cards: {
      ...
      macos: {
        title: "macOS",
        desc: "Gateway 的菜单栏伴侣应用 — 通知、批准和快速聊天。",
      },
      windows: {
        title: "Windows",
