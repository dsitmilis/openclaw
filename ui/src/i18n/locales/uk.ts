...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionArchived: "Сесію заархівовано",
    sessionsArchived: "Заархівовано сесій: {count}",
  ...
  mcpServers: {
    ...
    adminRequired: "Зміни на сервері MCP потребують доступу operator.admin.",
    enable: "Увімкніть",
    disable: "Вимкнути",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, говоріть, схвалюйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Оглядові чати та швидкі відповіді з вашого зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Компаньйон Windows підключає ваш ПК як вузол OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Міркування",
      speed: "Швидкість",
      sessionOverride: "Перевизначення сесії",
