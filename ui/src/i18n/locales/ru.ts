...
export const ru: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Архивировано сеансов: {count}",
    deleteAllArchived: "Удалить весь архив…",
    deleteAllArchivedConfirm: "Удалить {count} архивных сеансов и их расшифровки?",
  ...
  custodian: {
    ...
    requestFailed: "OpenClaw не удалось ответить. Попробуйте снова.",
    connectionChanged: "Подключение к Gateway изменилось. Повторите, чтобы продолжить настройку.",
  ...
  mcpServers: {
    ...
    nameInvalid: "Имена серверов могут содержать буквы, цифры, точки, дефисы и подчёркивания.",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Общайтесь, говорите, одобряйте действия и делитесь в OpenClaw с iOS.",
      },
      android: {
        title: "Android",
      ...
      chrome: {
        ...
        desc: "Позвольте OpenClaw управлять вашим текущим Chrome — вкладки, страницы и формы.",
      },
      plugins: {
  ...
  chat: {
    ...
    messages: {
      ...
      rewind: "Перемотать",
      rewindConfirm: "Перемотать до момента перед этим сообщением?",
