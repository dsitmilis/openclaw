...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway zwischen deinen Geräten synchronisiert.",
    notifications: {
      ...
      nativeBlockedHint:
        "Benachrichtigungen sind für OpenClaw in macOS deaktiviert. Erlaube sie unter Systemeinstellungen > Benachrichtigungen.",
    },
    appearance: {
      theme: "Design",
  ...
  subtitles: {
    ...
    advanced: "Alle verbleibenden Konfigurationsabschnitte plus der Rohdatei-Editor.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Deine Anleitung zur Systemeinrichtung",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für dein Handy, deine Uhr, deinen Desktop und deinen Browser – plus Plugins, um die Möglichkeiten deines Agenten zu erweitern.",
  ...
  chat: {
    ...
    messages: {
      ...
      rewind: "Zurückspulen",
      rewindConfirm: "Auf den Zeitpunkt vor dieser Nachricht zurückspulen?",
