...
export const nl: TranslationMap = {
  ...
  custodian: {
    ...
    sensitivePlaceholder: "Gevoelige waarde invoeren…",
    sensitiveReply: "Gevoelig antwoord verzonden",
    send: "Verzenden",
    thinking: "OpenClaw is aan het nadenken",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begeleidende apps voor je telefoon, horloge, desktop en browser — plus plugins om uit te breiden wat je agent kan.",
