...
export const es: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} sesiones archivadas",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint:
        "Las notificaciones se muestran de forma nativa mediante la app de OpenClaw en este Mac.",
      ...
      nativeBlockedHint:
        "Las notificaciones están desactivadas para OpenClaw en macOS. Permítelas en Configuración del Sistema > Notificaciones.",
    },
    appearance: {
      theme: "Tema",
