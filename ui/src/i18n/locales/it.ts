...
export const it: TranslationMap = {
  ...
  sessionsView: {
    ...
    global: "Globale",
    unknown: "Sconosciuto",
    sessionState: "Stato della sessione",
    viewArchived: "Visualizza archiviate",
    sessionArchived: "Sessione archiviata",
    sessionsArchived: "{count} sessioni archiviate",
  ...
  subtitles: {
    ...
    advanced: "Tutte le sezioni di configurazione rimanenti, più l'editor del file grezzo.",
  ...
  mcpServers: {
    ...
    nameTaken: "Un server MCP denominato “{name}” esiste già.",
  ...
  mcpPage: {
    connectorsLink: "Scopri i connettori con un solo clic nella pagina Plugin.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Filtrato",
  ...
  appsPage: {
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "L'app companion Windows collega il tuo PC come nodo OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  chat: {
    ...
    messages: {
      ...
      forkUnavailable: "La divisione non è disponibile mentre l'agente è al lavoro",
    ...
    modelControls: {
      ...
      usingDefault: "Utilizzo dell'impostazione predefinita dalle Impostazioni",
