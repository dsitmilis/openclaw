...
export const tr: TranslationMap = {
  ...
  appsPage: {
    heroTitle: "OpenClaw'ı her yere taşıyın",
    heroTagline:
    ...
    ctaOpenPlugins: "Plugins'i aç",
    ctaBrowseClawHub: "ClawHub'a Göz Atın",
  ...
  chat: {
    ...
    messages: {
      ...
      rewindUnavailable: "Ajan çalışırken geri sarma kullanılamaz",
      forkUnavailable: "Ajan çalışırken çatallama kullanılamaz",
    ...
    modelControls: {
      ...
      usingDefault: "Ayarlardan gelen varsayılan kullanılıyor",
