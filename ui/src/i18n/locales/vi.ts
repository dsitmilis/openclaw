...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud worker yêu cầu OpenClaw runtime; {runtime} đang được chọn.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh các cuộc trò chuyện và trả lời nhanh ngay trên cổ tay bạn.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  chat: {
    ...
    messages: {
      ...
      rewindUnavailable: "Không thể tua lại khi tác nhân đang hoạt động",
