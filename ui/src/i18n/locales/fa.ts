...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      noApp: "هنوز اپ را ندارید؟",
      getApps: "دریافت اپ‌ها",
  ...
  sessionsView: {
    ...
    deleteAllArchivedConfirm: "{count} نشست بایگانی‌شده و رونوشت‌های آن‌ها حذف شود؟",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "اعلان‌ها به‌صورت بومی توسط اپ OpenClaw روی این Mac نمایش داده می‌شوند.",
  ...
  mcpServers: {
    ...
    configUnavailable: "پیکربندی در دسترس نیست؛ تازه‌سازی کرده و دوباره تلاش کنید.",
  ...
  appsPage: {
    ...
    heroTagline:
      "برنامه‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌همراه پلاگین‌هایی برای گسترش توانایی‌های عامل شما.",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "از iOS چت کنید، صحبت کنید، اقدامات را تأیید کنید و به OpenClaw اشتراک‌گذاری کنید.",
      },
      android: {
        title: "Android",
        desc: "گوشی Android شما به‌عنوان یک گره کامل OpenClaw — چت، دوربین و Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "همراه Android امکان OpenClaw را به ساعت شما گسترش می‌دهد.",
      },
      macos: {
        title: "macOS",
        desc: "همراه نوار منو برای Gateway شما — اعلان‌ها، تأییدها و چت سریع.",
      },
      windows: {
        title: "Windows",
