...
export const pl: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Zobacz zarchiwizowane",
    ...
    deleteAllArchivedConfirm: "Usunąć {count} zarchiwizowanych sesji wraz z ich transkrypcjami?",
  ...
  subtitles: {
    ...
    custodian: "Konfiguracja i opieka nad systemem.",
  ...
  custodian: {
    ...
    sensitiveReply: "Poufna odpowiedź wysłana",
    send: "Wyślij",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory dostępne za jednym kliknięciem na stronie Plugins.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
