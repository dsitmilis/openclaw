...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개 세션이 보관되었습니다",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "이 Mac에서는 OpenClaw 앱이 알림을 네이티브로 표시합니다.",
  ...
  custodian: {
    ...
    exitSetup: "설정 종료",
    hatchDraft: "일어나요, 친구!",
    placeholder: "OpenClaw에게 메시지 보내기…",
  ...
  mcpServers: {
    ...
    adminRequired: "MCP 서버를 변경하려면 operator.admin 권한이 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
